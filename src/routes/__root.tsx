  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="mono text-[56px] leading-none">404</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FinBuild Pay — Checkout em cripto na Polygon" },
      {
        name: "description",
        content:
          "Protótipo de plataforma non-custodial de pagamentos em USDT e USDC na rede Polygon.",
      },
